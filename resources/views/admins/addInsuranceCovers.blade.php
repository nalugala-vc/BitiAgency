...
<div class="registrationForm">
    <form action="/submitCover" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="input">
                <span><i class="fa-solid fa-user"></i>Name</span>
                <input type="text" name="name" id="" placeholder="enter cover name">
            </div>
            <div class="input">
                <span><i class="fa-solid fa-envelope"></i>Price</span>
                <input type="number" name="price" id="" placeholder="enter insurance price">
            </div>
        </div>
        <div class="row">
            @if($errors->any())
