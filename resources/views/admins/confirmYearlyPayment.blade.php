...
@section('linkwords')
<a href="/receivedYearlyPayment">
    view received yearly payments
</a>
@endsection
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td><form action="/confirmYearlyPayment/{{$payment->id}}" method="POST">
                    @csrf
                    @method('PUT')
                    <button id="gr" type="submit">Received</button>
                </form></td>
                <td><form action="/declineYearlyPayment/{{$payment->id}}" method="POST">
                    @csrf
                    @method('PUT')
